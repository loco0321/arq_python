"""
Django settings for arq_python2 project.
...
SECRET_KEY = 'django-insecure-jnm!plh%xlvuujo@(@d-#mb47bls&-0zha)%*ayg2f=wtdzhq4'
...
WSGI_APPLICATION = 'arq_python2.wsgi.application'
